...
export default function ArrowButton({ 
    ...
    const classes = cn(
        "group inline-flex h-12 items-center gap-2.5 rounded-full bg-brand text-white",
...
function Arrow({ className, direction = "right" }: { className?: string; direction?: "left" | "right" }) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
