...
export default function PanoramaViewer({
  ...
  return (
    <div
      ...
      {/* Badge Indicator */}
      {!loading && !error && (
        <div className="absolute top-4 left-4 pointer-events-none lg:flex items-center gap-2 bg-black/50 text-white backdrop-blur-md px-3 py-1.5 rounded-full text-xs font-mono tracking-wider shadow border border-white/10 select-none hidden ">
