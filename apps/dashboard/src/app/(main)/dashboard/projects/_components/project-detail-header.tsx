...
export function ProjectDetailHeader({ project, client, onEdit, onRequestDelete }: ProjectDetailHeaderProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between gap-16 border-b pb-6 md:flex-row md:items-center">
