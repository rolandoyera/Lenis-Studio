    ...
    <div className="flex w-full flex-col gap-6">
      ...
      <div className="flex flex-col items-center justify-between gap-4 border-b pb-4 md:flex-row">
        ...
        <Tabs
          ...
          className="hidden w-full md:w-auto 3xl:block">
        ...
        <Select value={activeCategory} onValueChange={setActiveCategory}>
          <SelectTrigger className="w-full md:w-[220px] 3xl:hidden">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 3xl:grid-cols-7">
