...
interface LeadsTableProps {
  leads: Lead[];
  /** uid → full name map for resolving `assignedTo`. */
  userMap: Record<string, string>;
  /** Signed-in user's uid; their assignments render as "You". */
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Track and qualify incoming leads.</CardDescription>
        <CardAction>
          <div className="flex items-center gap-2">
            ...
            <Button className="flex items-center gap-2" onClick={onAddLead}>
